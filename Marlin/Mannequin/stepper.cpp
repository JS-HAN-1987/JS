...
extern bool oc_req_pause, oc_req_resume;
bool oc_paused = false;

#ifdef OC_NPDM
bool disable_z_min = false;
#endif
...
if (!oc_paused) {
    ...
    if ((out_bits & (1<<Z_AXIS)) != 0) {   // -direction
      ...
      CHECK_ENDSTOPS
      {
          ...
          #ifdef OC_NPDM
		  	#if defined(NPDM_PIN) && NPDM_PIN > -1
			|| (READ(NPDM_PIN) != NPDM_ENDSTOP_INVERTING)
			#endif
		  #endif
          ;
