...
int tft_printchar(int x, int y, int flags, char c, bool draw)
{
	...
	case '1': dx = tft_printletter_09(x, yy, flags, font_1, draw); break;
	...
	case ' ': dx = tft_printletter(x, yy, flags, font_space, draw); break;
	case 'A': dx = tft_printletter(x, yy, flags, font_upper_A, draw); break;
	case 'B': dx = tft_printletter(x, yy, flags, font_upper_B, draw); break;
	case 'C': dx = tft_printletter(x, yy, flags, font_upper_C, draw); break;
	...
	case 'G': dx = tft_printletter(x, yy, flags, font_upper_G, draw); break;
	...
	case 'M': dx = tft_printletter(x, yy, flags, font_upper_M, draw); break;
	case 'N': dx = tft_printletter(x, yy, flags, font_upper_N, draw); break;
	case 'O': dx = tft_printletter(x, yy, flags, font_upper_O, draw); break;
	case 'P': dx = tft_printletter(x, yy, flags, font_upper_P, draw); break;
	case 'Q': dx = tft_printletter(x, yy, flags, font_upper_Q, draw); break;
	case 'R': dx = tft_printletter(x, yy, flags, font_upper_R, draw); break;
	case 'S': dx = tft_printletter(x, yy, flags, font_upper_S, draw); break;
	case 'T': dx = tft_printletter(x, yy, flags, font_upper_T, draw); break;
	case 'U': dx = tft_printletter(x, yy, flags, font_upper_U, draw); break;
	case 'V': dx = tft_printletter(x, yy, flags, font_upper_V, draw); break;
	...
	case 'a': dx = tft_printletter(x, yy, flags, font_lower_a, draw); break;
	case 'b': dx = tft_printletter(x, yy, flags, font_lower_b, draw); break;
	case 'c': dx = tft_printletter(x, yy, flags, font_lower_c, draw); break;
	case 'd': dx = tft_printletter(x, yy, flags, font_lower_d, draw); break;
	case 'e': dx = tft_printletter(x, yy, flags, font_lower_e, draw); break;
	case 'f': dx = tft_printletter(x, yy, flags, font_lower_f, draw); break;
	case 'g': dx = tft_printletter(x, yy, flags, font_lower_g, draw); break;
	case 'h': dx = tft_printletter(x, yy, flags, font_lower_h, draw); break;
	case 'i': dx = tft_printletter(x, yy, flags, font_lower_i, draw); break;
	case 'j': dx = tft_printletter(x, yy, flags, font_lower_j, draw); break;
	case 'k': dx = tft_printletter(x, yy, flags, font_lower_k, draw); break;
	case 'l': dx = tft_printletter(x, yy, flags, font_lower_l, draw); break;
	case 'm': dx = tft_printletter(x, yy, flags, font_lower_m, draw); break;
	case 'n': dx = tft_printletter(x, yy, flags, font_lower_n, draw); break;
	case 'o': dx = tft_printletter(x, yy, flags, font_lower_o, draw); break;
	case 'p': dx = tft_printletter(x, yy, flags, font_lower_p, draw); break;
	case 'q': dx = tft_printletter(x, yy, flags, font_lower_q, draw); break;
	case 'r': dx = tft_printletter(x, yy, flags, font_lower_r, draw); break;
	case 's': dx = tft_printletter(x, yy, flags, font_lower_s, draw); break;
	case 't': dx = tft_printletter(x, yy, flags, font_lower_t, draw); break;
	case 'u': dx = tft_printletter(x, yy, flags, font_lower_u, draw); break;
	case 'v': dx = tft_printletter(x, yy, flags, font_lower_v, draw); break;
	case 'w': dx = tft_printletter(x, yy, flags, font_lower_w, draw); break;
	case 'x': dx = tft_printletter(x, yy, flags, font_lower_x, draw); break;
	case 'y': dx = tft_printletter(x, yy, flags, font_lower_y, draw); break;
	case 'z': dx = tft_printletter(x, yy, flags, font_lower_z, draw); break;
	...
	case ':': dx = tft_printletter(x, yy, flags, font_colon, draw); break;
	...
	case '`': dx = tft_printletter(x, yy, flags, font_do, draw); break;
