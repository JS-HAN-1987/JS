...
#ifdef IGNORE_MINTEMP
#define COMMON_MINTEMP 0
#else
#define COMMON_MINTEMP 5
#endif
#define HEATER_0_MINTEMP COMMON_MINTEMP
#define HEATER_1_MINTEMP COMMON_MINTEMP
#define HEATER_2_MINTEMP COMMON_MINTEMP
#define HEATER_3_MINTEMP COMMON_MINTEMP
#define BED_MINTEMP COMMON_MINTEMP
