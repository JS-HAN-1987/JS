...
bool Bounce::pressed()
{
  return getStateFlag(DEBOUNCED_STATE) == bActiveHigh ? true : false;
}

void Bounce::setActiveHigh()
{
  bActiveHigh = true;
}

bool Bounce::released()
{
  return getStateFlag(DEBOUNCED_STATE) == bActiveHigh ? false : true;
}
